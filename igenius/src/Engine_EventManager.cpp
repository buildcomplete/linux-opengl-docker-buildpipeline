...
MOUSE_MODE_FLAGS Engine_InputEventManager::GetFlags()
{
    return flags;
}

void Engine_InputEventManager::UpdateStateFromInput()
{
...
bool Engine_InputEventManager::did_enter_state(MOUSE_MODE_FLAGS testState)
{
    return (testState & flags & flippedFlags);
}
bool Engine_InputEventManager::did_exit_state(MOUSE_MODE_FLAGS testState)
{
    return (testState & ~flags & flippedFlags);
}
